...
public class InventoryController {
    ...
    @PostMapping
    public ResponseEntity<Equipment> createEquipment(EquipmentDTO equipmentDTO){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Equipment> updateEquipment(Long id, EquipmentDTO equipmentDTO){
